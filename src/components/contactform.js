...
import contactusbg from '../images/Contactform.png'
            ...
            <div className="container">
                <div className="row justify-content-center">
                    ...
                    {/* <div className="col-12 text-center py-5">
                        <h2 className="contactuspg-heading-row">Contact Us</h2>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-5 contactuspg-info mb-4">
                            ...
                            >
                                ...
                                <a href="mailto:info@designprinto.com" className="contactuspg-link">
                                    <FaEnvelope /> info@designprinto.com
                                </a>
                                {/* Social Icons */}
